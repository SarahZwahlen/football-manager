...
import { deletePlayer } from '../../utils/player'
...
export function Player({playerData, team_index, playerIndex}) {
  ...
  const handleDelete = (e) => {
    e.preventDefault()
    const result = deletePlayer(footballData, playerData.id, team_index)
  ...
  return(
    <div>
      ...
      {isEditingPlayer && <PlayerEdit teamIndex={team_index} playerIndex={playerIndex}></PlayerEdit>}
    </div>
  )
}